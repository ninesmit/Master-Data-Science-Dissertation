...
class SwinTransformer(nn.Module):
    def __init__(self, *, hidden_dim, layers, heads, channels=3, num_classes=1000, head_dim=32, window_size=7,
        ...
        # self.stage2 = StageModule(in_channels=channels, hidden_dimension=hidden_dim * 2, layers=layers[1],
        #                           downscaling_factor=downscaling_factors[1], num_heads=heads[1], head_dim=head_dim,
        #                           window_size=window_size, relative_pos_embedding=relative_pos_embedding)
        
        self.stage3 = StageModule(in_channels=channels, hidden_dimension=hidden_dim * 4, layers=layers[2],
...
mode = 2
image_size = 128
text_file_name = 'Swin_with_scattering_2modules_removed.txt'
hidden_dim = 96
layers = (2,2,6,2)
heads = (3,6,12,24)
num_classes = 10
...
for epoch in range(0, num_epoch):
    ...
    if (epoch + 1) % 10 == 0:
        torch.save(model.state_dict(), f'Swin_with_scattering_2modules_removed_epoch_{epoch+1}.pth')
