...
class Scattering2dEffNet(nn.Module):
    ...
    def build(self):
        ...
        self.eff.features[0][0].block[0][0] = nn.Conv2d(self.scattering_output_channels, 192, kernel_size=1, stride=1, bias=False)
...
for epoch in range(0, num_epoch):
    ...
    if (epoch + 1) % 20 == 0:
        torch.save(model.state_dict(), f'EffB3_1st_and_2nd_blocks_J1_removed_epoch_{epoch+1}.pth')
